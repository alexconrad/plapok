...
<div class="page-wrap">
                ...
                <div class="card justify-content-center" style="width: 300px;" align="center">
                    ...
                    <div class="card-body justify-content-center">
                        ...
                        <form action="<?= Common::link([WebController::class, 'joinRoom']) ?>" method="post">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" name="name" id="jrk" placeholder="Your name" required
                        ...
                        <form action="<?= Common::link([WebController::class, 'createRoom']) ?>" method="post">
                            <div class="input-group mb-3" style="padding-top: 14px;">
                                <input type="text" name="username" class="form-control" id="basic-url" aria-describedby="basic-addon3"
                                       autocomplete="off" placeholder="Your name" required value="<?php
                                echo(!empty($_COOKIE[RoomService::COOKIE_NAME]) ? $_COOKIE[RoomService::COOKIE_NAME] : '');
                                ?>">
                            </div>
                            </p>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="youAreKicked">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">You are no longer in the room</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <p style="margin-left: 140px;"><img src="assets/silence-5.6s-150px.svg" alt="silence"></p>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-dismiss="modal" style="margin-right: 200px;">Close</button>
                    </div>
                </div>
            </div>
        </div>
