...
<script>
    ...
    function kickParticipant(kickParticipantName) {
        $.ajax({
            type: "POST",
            url: "<?=Common::link([XHRController::class, 'xhrKickParticipant'])?>",
            data: {"kickParticipantName": kickParticipantName}
        }).done(function (data) {
            $('#kickParticipant').modal('hide');
        });
    }
...
<div class="modal" tabindex="-1" role="dialog" id="kickParticipant">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Kick <span id="kickName"></span> ?</h5>
    ...
    <div class="card" style="margin: 0px 0px 10px 0px;border-width: 0;background: #f5f5f5">
        <div class="card-body">
            <div class="input-group mb-3">
                ...
                <div class="input-group-prepend">
                    <span class="input-group-text" id="basic-addon3" style="font-size: 20px;">
                        <A href="<?= Common::link([WebController::class, 'exitRoom']) ?>" title="Exit">
